...
local HiddenPackage = { -- Статуэтки
	...
	["Los Santos International"] = {
		[1] = {2197.9, -2619.7, 13.5}, 
		[2] = {1470.3, -2311.9, 13.5}, 
		[3] = {1651, -2266.8, -1.3}, 
		[4] = {1383.5, -2586.2, 13.5}, 
		[5] = {1627.5, -2286.5, 94.1}, 
	},
	["Come-A-Lot"] = {
		[1] = {2365.6, 1006.3, 10.8}, 
	},
	["Cranberry Station"] = {
		[1] = {-1973.1, 114.8, 30.6}, 
	},
	...
	["Redsands East"] = {
		[1] = {1980.7, 2166.1, 11.1}, 
		[2] = {1976.3, 2266.9, 27.2}, 
		[3] = {1972.6, 2294.7, 16.5}, 
		[4] = {1939.4, 2375.5, 23.9}, 
		[5] = {1875.3, 2076.4, 16.1}, 
	},
	["Randolph Industrial Estate"] = {
		[1] = {1628.3, 600.6, 1.8}, 
	},
	["Roca Escalante"] = {
		[1] = {2288.3, 2442.9, 10.8}, 
	},
	["The Camel's Toe"] = {
		[1] = {2339.7, 1305, 67.5}, 
	},
	["Leafy Hollow"] = {
		[1] = {-1104.3, -1639.4, 76.4}, 
	},
	["Caligula's Palace"] = {
		[1] = {2406.2, 1681.4, 14.3}, 
	},
	["Market"] = {
		[1] = {1248.3, -1250, 63.7}, 
		[2] = {1073.8, -1303.7, 17.1}, 
	},
	["Missionary Hill"] = {
		[1] = {-2531.8, -704.7, 139.3}, 
	},
	["Restricted Area"] = {
		[1] = {164.1, 1849.9, 33.9}, 
		[2] = {232, 1858.2, 15.8}, 
	...
	["Pilgrim"] = {
		[1] = {2454.5, 1499.5, 11.6}, 
	},
	["Angel Pine"] = {
		[1] = {-2155.8, -2352.2, 30.7}, 
	},
	["Glen Park"] = {
		[1] = {1915.3, -1354.9, 23.4}, 
	},
	["Kincaid Bridge"] = {
		[1] = {-1113.2, 845.5, 3.1}, 
	},
	["Yellow Bell Golf Course"] = {
		[1] = {1488.7, 2773.9, 10.8}, 
		[2] = {1432.6, 2751.3, 19.5}, 
	},
	["Las Payasadas"] = {
		[1] = {-242.2, 2712.4, 66.8}, 
	},
	...
	["Las Venturas Airport"] = {
		[1] = {1715.4, 1313.3, 10.8}, 
		[2] = {1690, 1484, 11.7}, 
		[3] = {1580.7, 1488.9, 17.2}, 
		[4] = {1617.8, 1440, 25.7}, 
		[5] = {1308.1, 1261.4, 14.3}, 
	},
	["Ganton"] = {
		[1] = {2482.7, -1642.6, 23.4}, 
		[2] = {2320.6, -1631.8, 14.7}, 
	},
	["Las Colinas"] = {
		[1] = {2013.8, -962.7, 42.5}, 
		[2] = {2426.5, -1015.3, 54.3}, 
	},
	["The Visage"] = {
		[1] = {2094.8, 1890.3, 10.4}, 
	},
	["Whetstone"] = {
		[1] = {-1848.5, -1708.7, 41.1}, 
		[2] = {-1619.6, -2690.4, 48.7}, 
	},
	["Red County"] = {
		[1] = {875.3, -589.4, 18}, 
	},
	...
	["Ocean Docks"] = {
		[1] = {2233.4, -2283.1, 14.4}, 
		[2] = {2768.5, -2568.8, 3}, 
	},
	["East Beach"] = {
		[1] = {2666.1, -1438.7, 16.3}, 
		[2] = {2866.2, -1588.5, 22.4}, 
		[3] = {2820.2, -1467.4, 36.1}, 
		[4] = {2680.1, -1807.3, 31.4}, 
	},
	["Juniper Hill"] = {
		[1] = {-2278.6, 629.8, 53.1}, 
		[2] = {-2446.8, 758, 41.3}, 
...
for name, dat in pairs(HiddenHorse) do
	for i, v in pairs(dat) do
		HiddenHorse[name][i] = createPickup(v[1],v[2],v[3], 3, 954, 0)
	end
end


for name, dat in pairs(HiddenPackage) do
	for i, v in pairs(dat) do
		HiddenPackage[name][i] = createPickup(v[1],v[2],v[3], 3, 1276, 0)
	end
end


for name, dat in pairs(HiddenOYSTER) do
	for i, v in pairs(dat) do
		HiddenOYSTER[name][i] = createPickup(v[1],v[2],v[3], 3, 953, 0)
	end
end
...
function CheckZoneCollect(zone)
	...
	if(HiddenPackage[zone]) then
		local count, total = 0, 0
		for i, v in pairs(HiddenPackage[zone]) do
			if(isElement(v)) then
				count = count+1
			end
			total = total+1
		...
		if(count > 0) then
			PData["DisplayCollection"]["Реликвия"] = {total, count}
		end
	end
	
	
	if(HiddenHorse[zone]) then
		local count, total = 0, 0
		for i, v in pairs(HiddenHorse[zone]) do
			if(isElement(v)) then
				count = count+1
			end
			total = total+1
		...
		if(count > 0) then
			PData["DisplayCollection"]["Подкова"] = {total, count}
		end
	end
	
	if(HiddenOYSTER[zone]) then
		local count, total = 0, 0
		for i, v in pairs(HiddenOYSTER[zone]) do
			if(isElement(v)) then
				count = count+1
			end
			total = total+1
		...
		if(count > 0) then
			PData["DisplayCollection"]["Ракушка"] = {total, count}
		end
	end
end
...
function clientPickupHit(thePlayer, matchingDimension)
	if(thePlayer == localPlayer) then
		...
		local zone = getZoneName(x,y,z)
		if(getElementModel(source) == 954) then
			destroyElement(source)
			CheckZoneCollect(zone)
		elseif(getElementModel(source) == 1276) then
			destroyElement(source)
			CheckZoneCollect(zone)
		elseif(getElementModel(source) == 953) then
			destroyElement(source)
			CheckZoneCollect(zone)
		end
	end
